...
void FitMassModel(RooWorkspace &myws) {
  ...
  RooDataSet *data = tree2DataSet_NEW("AO2D_NEW_DCA.txt","O2rtdimuonall", tau, mass, ptmin, ptmax, chi2opti);
  ...
  //myws.factory(Form("cste[%.4f]", 0.));

  /*myws.factory(Form("mJPsi[%.4f,%.4f,%.4f]",  3.1117 , 3.0 , 3.2));
  myws.factory(Form("sigma[%.4f,%.4f,%.4f]",  0.0622 , 0.01, 0.08));
  myws.factory(Form("n1[%.4f,%.4f,%.4f]",     2.5243 , 0.72, 4.33));
  myws.factory(Form("alpha1[%.4f,%.4f,%.4f]", 1.3211 , 0.62, 2.07));
  myws.factory(Form("n2[%.4f,%.4f,%.4f]",     2.0000 , 1.82, 2.18));
  myws.factory(Form("alpha2[%.4f,%.4f,%.4f]", 2.0936 , 1.91, 2.28));*/

  //For Exp
  //myws.factory(Form("lambdas[%.4f,%.4f,%.4f]", -1.0701, -4., 1.2));

  //For VWG
  /*myws.factory(Form("A[%.4f,%.4f,%.4f]", 1., 0., 10.)); //0.34
  myws.factory(Form("B[%.4f,%.4f,%.4f]", 2.94, -10., 10.));
  myws.factory(Form("C[%.4f,%.4f,%.4f]", -0.02, -10., 10.)); //-0.02*/
  ...
  myws.factory(Form("sigma[%.4f]", 0.0460));
  myws.factory(Form("n1[%.4f]", 4.3286));
  myws.factory(Form("alpha1[%.4f]",  0.7081));
  myws.factory(Form("n2[%.4f]", 1.8200));
  myws.factory(Form("alpha2[%.4f]", 2.2337));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0473));
  myws.factory(Form("n1[%.4f]",     4.2650));
  myws.factory(Form("alpha1[%.4f]", 0.7424));
  myws.factory(Form("n2[%.4f]",     2.1523));
  myws.factory(Form("alpha2[%.4f]", 2.2796));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0506));
  myws.factory(Form("n1[%.4f]",     4.3300));
  myws.factory(Form("alpha1[%.4f]", 0.8734));
  myws.factory(Form("n2[%.4f]",     2.1800));
  myws.factory(Form("alpha2[%.4f]", 2.2800));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0536));
  myws.factory(Form("n1[%.4f]",     3.8432));
  myws.factory(Form("alpha1[%.4f]", 0.9459));
  myws.factory(Form("n2[%.4f]",     2.1800));
  myws.factory(Form("alpha2[%.4f]", 2.2800));
  myws.factory(Form("A[%.4f]",      1.2113));
  myws.factory(Form("B[%.4f]",      1.0804));
  myws.factory(Form("C[%.4f]",      -0.0519));*/

  //4-5 DCA Chi2 45 VWG sig CB2 data tails cste = 0
  /*myws.factory(Form("mJPsi[%.4f]",  3.0924));
  myws.factory(Form("sigma[%.4f]",  0.0587));
  myws.factory(Form("n1[%.4f]",     3.9183));
  myws.factory(Form("alpha1[%.4f]", 1.0088));
  myws.factory(Form("n2[%.4f]",     2.1800));
  myws.factory(Form("alpha2[%.4f]", 2.2800));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0594));
  myws.factory(Form("n1[%.4f]",     4.3300));
  myws.factory(Form("alpha1[%.4f]", 0.9724));
  myws.factory(Form("n2[%.4f]",     2.1797));
  myws.factory(Form("alpha2[%.4f]", 2.2797));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0600));
  myws.factory(Form("n1[%.4f]",     4.3300));
  myws.factory(Form("alpha1[%.4f]", 0.9325));
  myws.factory(Form("n2[%.4f]",     2.1795));
  myws.factory(Form("alpha2[%.4f]", 1.9768));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0627));
  myws.factory(Form("n1[%.4f]",     3.4896));
  myws.factory(Form("alpha1[%.4f]", 1.1343));
  myws.factory(Form("n2[%.4f]",     1.8236));
  myws.factory(Form("alpha2[%.4f]", 1.9276));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0625));
  myws.factory(Form("n1[%.4f]",     4.3300));
  myws.factory(Form("alpha1[%.4f]", 1.0195));
  myws.factory(Form("n2[%.4f]",     1.8200));
  myws.factory(Form("alpha2[%.4f]", 1.9101));
  ...
  myws.factory(Form("sigma[%.4f]",  0.0800));
  myws.factory(Form("n1[%.4f]",     4.3300));
  myws.factory(Form("alpha1[%.4f]", 0.9711));
  myws.factory(Form("n2[%.4f]",     2.1800));
  myws.factory(Form("alpha2[%.4f]", 1.9100));
  ...
  myws.factory(Form("cste[%.4f]", 0.00502486));*/
...
void MakePlots(RooWorkspace &myws) {
  ...
  t->SetTextSize(0.04);
  t->SetTextFont(42);
  t->DrawLatex(0.13, 0.85, "ALICE performance, pp, #sqrt{s} = 13.6 TeV");
  dy += 0.06;
  t->DrawLatex(0.15, 0.85 - dy, Form("%.1f < |#it{y}^{#mu#mu}| < %.1f", 2.5, 3.6));
  dy += 0.05;
  t->DrawLatex(0.15, 0.85-dy, Form("%.0f GeV/c < #it{p}_{T}^{#mu#mu} < %.0f GeV/c", pT1->getValV(), pT2->getValV()));
  dy += 0.05;
  ...
  dy += 0.1;
  t->SetTextSize(0.03);
  t->DrawLatex(0.2, 0.8 - dy, Form("N_{J/#psi} = %.0f#pm%.0f", nsig->getValV(), nsig->getError()));
  dy += 0.05;
  t->DrawLatex(0.2, 0.8 - dy, Form("N_{bkg} = %.0f#pm%.0f", nbkg->getValV(), nbkg->getError()));
  dy += 0.05;
  ...
  //if bkg is VWG
  /*t->DrawLatex(0.7, 0.89 - dy, Form("A = %.4f#pm%.4f", A->getValV(), A->getError()));
  dy += 0.045;
  t->DrawLatex(0.7, 0.89 - dy, Form("B = %.4f#pm%.4f", B->getValV(), B->getError()));
  dy += 0.045;
  t->DrawLatex(0.7, 0.89 - dy, Form("C = %.4f#pm%.4f", C->getValV(), C->getError()));
  dy += 0.045;*/
  ...
  //pad2->Update();
  pad1->cd();
  t->DrawLatex(0.2, 0.8 - dy, Form("#chi^{2}/ndof = %.0f / %d ", chi2, ndof));
  pad1->Update();

  //Save the Canvas
  std::string canname  = Form("PrelFig/%s_pT%.0f_%.0f.pdf", cFig->GetName(), pT1->getValV(), pT2->getValV());
  std::string canname2 = Form("PrelFig/%s_pT%.0f_%.0f.C", cFig->GetName(), pT1->getValV(), pT2->getValV());
  cFig->SaveAs(canname.c_str());
  cFig->SaveAs(canname2.c_str());
...
void AddTauzSignalModel(RooWorkspace &myws) {
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.227944)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.098480));
  myws.factory(Form("n11[%.6f]", 1.301981));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.1620000)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.078229));
  myws.factory(Form("n11[%.6f]", 1.510333));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.143482)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.074434));
  myws.factory(Form("n11[%.6f]", 1.470809));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.116394)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.062369));
  myws.factory(Form("n11[%.6f]", 1.392624));
  myws.factory(Form("alpha11[%.6f]", 1.719490));
  myws.factory(Form("fres[%.4f]", 0.415299));
  myws.factory(Form("tzJPsi[%.6f]", 0.003248));*/
  
  //4-5 values VWG DCA Chi2 45
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.101222)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.065103));
  myws.factory(Form("n11[%.6f]", 1.519182));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.085230)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.051587));
  myws.factory(Form("n11[%.6f]", 1.492102));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.073486)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.044232));
  myws.factory(Form("n11[%.6f]", 1.414370));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.066396)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.037714));
  myws.factory(Form("n11[%.6f]", 1.604833));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.076460)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.036092));
  myws.factory(Form("n11[%.6f]", 1.167397));
  ...
  //myws.factory(Form("tzJPsi[%.6f]", 0.));
  /*myws.factory(Form("sigma1[%.6f]", 0.055604)); //10 0.5
  myws.factory(Form("sigma2[%.6f]", 0.025487));
  myws.factory(Form("n11[%.6f]", 1.406970));
...
void AddTauzBkgModel(RooWorkspace &myws) {
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.711332)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.603587)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.380547));
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.740330)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.606575)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.347283));
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.769662)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.677617)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.329510));
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.797264)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.622877)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.317348));
  myws.factory(Form("lambda_DF[%.4f]", 0.143120));
  myws.factory(Form("lambda_DDS[%.4f]", 1.818587));
  myws.factory(Form("tzJPsi_bkg[%.4f]", 0.038910));*/

  //4-5 values VWG DCA Chi2 45
  /*myws.factory(Form("b[%.4f]", 0.803463));
  myws.factory(Form("f_DLIV[%.4f]", 0.823292)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.681839)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.325878));
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.840063)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.668559)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.366071));
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.839180)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.611710)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.360047));
  ...
  myws.factory(Form("f_DLIV[%.4f]", 0.840876)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.832110)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.372590));
  ...
  //10-15 values VWG DCA Chi2 90
  /*myws.factory(Form("b[%.4f]", 0.9));
  myws.factory(Form("f_DLIV[%.4f]", 0.846909)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.759226)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.382863));
  ...
  //15-30 values VWG DCA Chi2 90
  /*myws.factory(Form("b[%.4f]", 0.8999));
  myws.factory(Form("f_DLIV[%.4f]", 0.890592)); 
  myws.factory(Form("f_DFSS[%.4f]", 0.871618)); 
  myws.factory(Form("lambda_DSS[%.4f]", 0.395301));
...
void MakeSignalPlot(RooWorkspace &myws) {
  ...
  TPad *pad1 = new TPad("pad1_TauzPP", "", 0, 0, 1, 1);
  //TPad *pad2 = new TPad("pad2_TauzPP", "", 0, 0, 1, .228);

  float titlesize = 0.045;
  float titleoffset = 0.99;
  ...
  //frame->GetYaxis()->SetRangeUser(Ydown, Yup*11);
  frame->GetYaxis()->SetRangeUser(5., 1e6);
  frame->GetXaxis()->SetRangeUser(-7, 7);
  delete h;
  ...
  double ymin = 0.7802;
  TLegend *leg = new TLegend(0.72, 0.71, 0.89, 0.85);
  //leg->SetTextSize(0.03);
  leg->SetTextSize(0.035);
  leg->SetLineColor(0);
  TLegendEntry *l1 = leg->AddEntry("gauss1", "Gauss", "l");
  l1->SetLineColor(kRed+1);
...
void MakeBkgPlot(RooWorkspace &myws) {
  ...
  TPad *pad1 = new TPad("pad1_Tauz", "", 0, 0, 1, 1);
  ...
  frame->GetYaxis()->SetTitleOffset(titleoffset);
  frame->GetYaxis()->SetLabelSize(labelsize);
  frame->GetYaxis()->SetRangeUser(4,1e6);
  frame->GetXaxis()->SetRangeUser(-7,7);
  ...
  TLegend *leg = new TLegend(0.68, 0.69, 0.86, 0.89);
  //leg->SetTextSize(0.03);
  leg->SetTextSize(0.035);
  leg->SetLineColor(0);
...
void MakeTotalPlot(RooWorkspace &myws){
  ...
  dy += 0.045;
  t->DrawLatex(0.2, 0.9 - dy, Form("f_{B} = %.3f#pm%.3f", fB->getValV(), fB->getError()));
  dy += 0.045;
  ...
  TLegend *leg = new TLegend(0.66, 0.66, 0.86, 0.89);
  leg->SetTextSize(0.03);
  ...
  ndof = nFullBins - nFitPar;
  t->DrawLatex(0.2, 0.9-dy, Form("#chi^{2}/ndof = %.0f / %d ", chi2, ndof));
  //pad2->Update();
}
...
void MakeFit2D(RooWorkspace &myws) {
  ...
  frame2bis->GetXaxis()->SetTitleSize(0.14);
  frame2bis->GetXaxis()->SetLabelSize(0.12);
  frame2bis->GetXaxis()->SetTitleOffset(0.95);
  frame2bis->GetYaxis()->SetTitleSize(0.12);
  frame2bis->GetYaxis()->SetLabelSize(0.12);
  frame2bis->GetYaxis()->SetTitleOffset(0.35);
  frame2bis->GetYaxis()->SetRangeUser(-5.9, 5.9);
  ...
  TCanvas *cFigbis = new TCanvas("c2DFitbis", "c2DFitbis", 1000, 800);
  TPad *pad1bis = new TPad("pad1_2DFitbis", "", 0, 0, 1, 1); // xlow, ylow, xup, yup
  ...
  //pad1bis->SetBottomMargin(0.);
  //pad2bis->SetTopMargin(0.);

  //pad2->SetBottomMargin(0.15);
  //pad2bis->SetBottomMargin(0.4);

  //framebis->GetYaxis()->SetRangeUser(5., 14000.);
  //framebis->GetYaxis()->SetRangeUser(5., 1e6);
  framebis->GetYaxis()->SetRangeUser(5, 1e7);
  framebis->GetXaxis()->SetRangeUser(-7, 7);

  framebis->GetXaxis()->SetTitleSize(titlesize);
  //frame->GetXaxis()->SetTitleOffset(titleoffset);
  framebis->GetXaxis()->SetLabelSize(labelsize);
  framebis->GetYaxis()->SetTitleSize(titlesize);
  framebis->GetYaxis()->SetTitleOffset(titleoffset);
  ...
  //t1->SetTextSize(0.04);
  //t1->SetTextFont(42);
  //t1->DrawLatex(0.13, 0.85, "ALICE preliminary");
  //dy1 += 0.05;
  //t1->DrawLatex(0.15, 0.8 - dy1, Form("pp, #sqrt{13.6} TeV %.1f < |y^{#mu#mu}| < %.1f", 2.5, 3.6));

  t1->SetTextSize(0.04);
  t1->SetTextFont(42);
  t1->DrawLatex(0.13, 0.85, "ALICE preliminary, pp, #sqrt{s} = 13.6 TeV");
  dy1 += 0.06;
  t1->DrawLatex(0.15, 0.85 - dy1, Form("%.1f < |#it{y}^{#mu#mu}| < %.1f", 2.5, 3.6));
  dy1 += 0.05;
  t1->DrawLatex(0.15, 0.85-dy1, Form("%.0f GeV/c < #it{p}_{T}^{#mu#mu} < %.0f GeV/c", pT1->getValV(), pT2->getValV()));
  dy1 += 0.1;
  //t1->SetTextSize(0.03);
  //t1->DrawLatex(0.7175, 0.69 - dy1, Form("%.1f < |y^{#mu#mu}| < %.1f", 2.5, 3.6));
  //dy1 += 0.05;
  //t1->DrawLatex(0.15, 0.8-dy1, Form("%.0f GeV/c < p_{T}^{#mu#mu} < %.0f GeV/c", pT1->getValV(), pT2->getValV()));
  // t->DrawLatex(0.5175, 0.69-dy, Form("%g < p_{T}^{#mu#mu} < %g
  // GeV/c",cut.dMuon.Pt.Min,cut.dMuon.Pt.Max)); dy+=0.045;
  //t1->DrawLatex(0.15, 0.9 - dy1, Form("Fit parameters : "));
  dy1 += 0.05;
  t1->DrawLatex(0.15, 0.8 - dy1, Form("N_{J/#psi} = %.0f#pm%.0f", nsig->getValV(), nsig->getError()));
  dy1 += 0.05;
  t1->DrawLatex(0.15, 0.8 - dy1, Form("N_{bkg} = %.0f#pm%.0f", nbkg->getValV(), nbkg->getError()));
  dy1 += 0.05;
  t1->DrawLatex(0.15, 0.8 - dy1, Form("f_{B} = %.3f#pm%.3f", myws.var("fB")->getValV(), myws.var("fB")->getError()));
  dy1 += 0.05;
  /*dy1 += 0.045;
  ...
  TLegend *leg_tau = new TLegend(0.66, 0.66, 0.86, 0.89);
  //leg_tau->SetTextSize(0.03);
  leg_tau->SetTextSize(0.04);
  ...
  pad1bis->cd();
  t1->DrawLatex(0.15, 0.8 - dy1, Form("#chi^{2}/ndof = %.0f / %d ", chi2, ndof));
  pad1bis->Update();
  ...
  auto res = TFile::Open(Form("fB_PDG_Full_%.0f%.0f_tzJPsi_free_GOODCORRBUMP.root", pT1->getValV(), pT2->getValV()), "RECREATE");
  frac->Write(Form("fB_PDG_%.0f%.0f", pT1->getValV(), pT2->getValV()));

  //Save the Canvas
  std::string canname  = Form("PrelFig/%s_pT%.0f_%.0f.pdf", cFigbis->GetName(), pT1->getValV(), pT2->getValV());
  std::string canname2 = Form("PrelFig/%s_pT%.0f_%.0f.C", cFigbis->GetName(), pT1->getValV(), pT2->getValV());
  cFigbis->SaveAs(canname.c_str());
  cFigbis->SaveAs(canname2.c_str());
  //==============================================================
