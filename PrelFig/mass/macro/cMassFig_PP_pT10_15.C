...
//=========  (Mon Mar 31 17:00:34 2025) by ROOT version 6.32.06
...
// ------------>Primitives in pad: pad1_PP
   ...
   TH1D *frame_mass_db06820__1 = new TH1D("frame_mass_db06820__1"," ",40,2.5,3.5);
   frame_mass_db06820__1->SetBinContent(1,902.2798);
   frame_mass_db06820__1->SetMinimum(5);
   frame_mass_db06820__1->SetMaximum(1500);
   frame_mass_db06820__1->SetEntries(1);
   frame_mass_db06820__1->SetDirectory(nullptr);
   frame_mass_db06820__1->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   frame_mass_db06820__1->SetLineColor(ci);
   frame_mass_db06820__1->GetXaxis()->SetTitle("M_{#mu#mu} (GeV/c^{2})");
   frame_mass_db06820__1->GetXaxis()->SetLabelFont(42);
   frame_mass_db06820__1->GetXaxis()->SetTitleSize(0.04);
   frame_mass_db06820__1->GetXaxis()->SetTitleOffset(1);
   frame_mass_db06820__1->GetXaxis()->SetTitleFont(42);
   frame_mass_db06820__1->GetYaxis()->SetTitle("Events / ( 0.025 GeV/c^{2} )");
   frame_mass_db06820__1->GetYaxis()->SetLabelFont(42);
   frame_mass_db06820__1->GetYaxis()->SetLabelSize(0.035);
   frame_mass_db06820__1->GetYaxis()->SetTitleSize(0.04);
   frame_mass_db06820__1->GetYaxis()->SetTitleOffset(1.25);
   frame_mass_db06820__1->GetYaxis()->SetTitleFont(42);
   frame_mass_db06820__1->GetZaxis()->SetLabelFont(42);
   frame_mass_db06820__1->GetZaxis()->SetTitleOffset(1);
   frame_mass_db06820__1->GetZaxis()->SetTitleFont(42);
   frame_mass_db06820__1->Draw("FUNC");
   ...
   TH1D *frame_mass_db06820__2 = new TH1D("frame_mass_db06820__2"," ",40,2.5,3.5);
   frame_mass_db06820__2->SetBinContent(1,902.2798);
   frame_mass_db06820__2->SetMinimum(5);
   frame_mass_db06820__2->SetMaximum(1500);
   frame_mass_db06820__2->SetEntries(1);
   frame_mass_db06820__2->SetDirectory(nullptr);
   frame_mass_db06820__2->SetStats(0);

   ci = TColor::GetColor("#000099");
   frame_mass_db06820__2->SetLineColor(ci);
   frame_mass_db06820__2->GetXaxis()->SetTitle("M_{#mu#mu} (GeV/c^{2})");
   frame_mass_db06820__2->GetXaxis()->SetLabelFont(42);
   frame_mass_db06820__2->GetXaxis()->SetTitleSize(0.045);
   frame_mass_db06820__2->GetXaxis()->SetTitleOffset(1);
   frame_mass_db06820__2->GetXaxis()->SetTitleFont(42);
   frame_mass_db06820__2->GetYaxis()->SetTitle("Events / ( 0.025 GeV/c^{2} )");
   frame_mass_db06820__2->GetYaxis()->SetLabelFont(42);
   frame_mass_db06820__2->GetYaxis()->SetLabelSize(0.04);
   frame_mass_db06820__2->GetYaxis()->SetTitleSize(0.045);
   frame_mass_db06820__2->GetYaxis()->SetTitleOffset(1.12);
   frame_mass_db06820__2->GetYaxis()->SetTitleFont(42);
   frame_mass_db06820__2->GetZaxis()->SetLabelFont(42);
   frame_mass_db06820__2->GetZaxis()->SetTitleOffset(1);
   frame_mass_db06820__2->GetZaxis()->SetTitleFont(42);
   frame_mass_db06820__2->Draw("AXISSAME");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.15,0.59,"#chi^{2}/ndof = 45 / 40 ");
   tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   ...
   cMassFig_PP->SaveAs("../pdf/cMassFig_PP_pT10_15.pdf");
   cMassFig_PP->SaveAs("../png/cMassFig_PP_pT10_15.png");
}
